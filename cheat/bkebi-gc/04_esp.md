...
#### 启动透视 <font size="2" color="#5FC3E4">&nbsp;<热键>&nbsp;</font>
...
- 针对于某些特别小的物体 若不设定有可能小到看不见。

- 范围: `0.1 ~ 200`

#### 显示自定义筛选器

是否显示 [自定义筛选器](/cheat/bkebi-gc/10_more_guis#自定义筛选器) 。

### Custom filters

 [自定义筛选器](/cheat/bkebi-gc/10_more_guis#自定义筛选器) 中创建的筛选器。

- 提示: 
  - `左键`勾选是否启用 `右键`更换对应项的颜色。
  - `搜索物品`仅支持英文关键词过滤 可在此处使用(Ctrl+F)中文搜索来定位指定物品。
