...
<!--
- 若在范围内检测到已完成的未标记点位 则会在控制台输出`Failed to find uncomoleted point for this object.`。
-->
#### 检测范围
...
**04** 在 [Bkebi Discord 服务器](https://discord.gg/bkebi) 的 **#keygen频道** 中使用 **`/generate free Bkebi 3.5.0 {HWID}`** 从Bot中生成密钥文件。
